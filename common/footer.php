...
<div class="container">
  <div class="row">
	 <div class="col-md-4 d-flex justify-content-center border-right-inner">
		<div class="footerLogo">
				<img src="<?php echo $sSiteURL; ?>media/common/logo.png" title="<?php echo $sSiteTitle; ?>" alt="<?php echo $sSiteTitle; ?>"class="img-fluid">		  
		</div>
	 </div>
	...
	<div class="container">
		<div class="row">
			<div class="col-sm-12 text-center">
				<p><span class="En">&copy;</span> <?php echo fEn2Bn(date("Y")); ?> | <?php echo $sSiteName; ?>  কর্তৃক সর্বসত্ব ® সংরক্ষিত | উন্নয়নে <a href="https://www.emythmakers.com" target="_blank">ইমিথমেকারস.কম</a></p>
			</div>
		</div>
	</div>
</div>
	...
	<div class="DScrollSection">
		...
		<div class="ScrollSubject">
			<marquee onmouseover="this.stop();" onmouseout="this.start();">
				...
				<a href="#"><span><div class="SquareIcon"></div> সামাজিক মাধ্যমে গুজব রটনাকারীদের বিরুদ্ধে ব্যবস্থা নিচ্ছে পুলিশ</span></a>
