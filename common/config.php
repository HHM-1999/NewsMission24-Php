<?php
$sInitialBN="News Mission 24";
$sInitialEN="News Mission 24";
$sSiteName="News Mission 24";
$sSiteTitle="News Mission 24";
$sDescription="News Mission 24";
$sAuthor="News Mission 24";
$sDeveloper="eMythMakers.com";
$sEmail="NewsMission24@emm.com";
$sAppId="";

//Local
$sSiteURL="http://localhost/NewsMission24/";
$sCurrURL="http://localhost/NewsMission24".$_SERVER["REQUEST_URI"];

//Web
//   $sSiteURL="https://www.emythmaker.com/project/Template/NewsProtal/DailyJanakantha/Demo4/";
//   $sCurrURL="https://www.emythmaker.com/project/Template/NewsProtal/DailyJanakantha/Demo4".$_SERVER["REQUEST_URI"];
...
$sCSSFontAwesome='<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.7.1/css/all.min.css" />';
...
$sBackUpTop='<div id="button" class="back_to_top show"><span class="go_up"><i class="fas fa-angle-double-up"></i></span></div>';
